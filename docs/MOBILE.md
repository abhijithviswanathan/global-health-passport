...
Signed QR credentials, QR scanning, appointments, notifications, medication reminder scheduling, secure document viewing, native passkeys and native distribution signing remain original-scope gaps.
